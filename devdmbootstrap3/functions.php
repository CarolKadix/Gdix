...
////////////////////////////////////////////////////////////////////
    ...
    set_post_thumbnail_size(300,300, true);
        ...
        add_image_size( 'single', 640, null, true);
        add_image_size( 'slides', 640, 427, true);
        add_image_size( 'full', 940, null, true );
        add_image_size( 'cards-home', 640, 427, true );         
        add_image_size( 'destaques', 260, 180, true );          
        add_image_size( 'secoes', 300, 250, true ); 
        add_image_size( 'rank', 320, 214, true );   
